        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldValuesJson = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: true),
                    NewValuesJson = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommunityId = table.Column<long>(type: "bigint", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    StartPoint = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    EndPoint = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    StartLatitude = table.Column<decimal>(type: "decimal(9,6)", nullable: false),
                    StartLongitude = table.Column<decimal>(type: "decimal(9,6)", nullable: false),
                    EndLatitude = table.Column<decimal>(type: "decimal(9,6)", nullable: false),
                    EndLongitude = table.Column<decimal>(type: "decimal(9,6)", nullable: false),
                    DistanceKm = table.Column<decimal>(type: "decimal(8,3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_Communities_CommunityId",
                        column: x => x.CommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Groups_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupSubscriptions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccuracyMeters = table.Column<decimal>(type: "decimal(6,2)", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_GroupId_BookingDate",
                table: "Bookings",
                columns: new[] { "GroupId", "BookingDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriverLocations_TripId_RecordedAt",
                table: "DriverLocations",
                columns: new[] { "TripId", "RecordedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Groups_CommunityId_Status",
                table: "Groups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_RouteId",
                table: "Groups",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_Groups_VehicleId",
                table: "Groups",
                column: "VehicleId");
